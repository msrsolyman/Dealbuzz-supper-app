      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 md:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filtered.map((product) => (
            <div
              key={product._id}
              className="bg-white rounded-[2rem] border border-slate-200 overflow-hidden shadow-sm hover:shadow-xl hover:border-indigo-200 transition-all group flex flex-col"
            >
            ...
            >
              <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                ...
                <button
                  ...
                  className="text-slate-400 hover:text-slate-600 p-2 bg-white rounded-xl shadow-sm"
                >
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-4">
                {cart.length === 0 ? (
                  ...
                  cart.map((item) => (
                    <div
                      key={item._id}
                      className="flex gap-4 items-center bg-white border border-slate-100 p-3 rounded-2xl shadow-sm"
                    >
                      ...
                      <div className="flex items-center gap-2 bg-slate-50 p-1 rounded-lg border border-slate-100">
                        <button
                          ...
                          className="w-6 h-6 flex items-center justify-center text-slate-500 hover:text-red-500 hover:bg-white rounded shadow-sm transition-all text-lg font-medium leading-none"
                        >
                          -
                        </button>
                        ...
                        <button
                          ...
                          className="w-6 h-6 flex items-center justify-center text-slate-500 hover:text-indigo-600 hover:bg-white rounded shadow-sm transition-all text-lg font-medium leading-none"
                        >
                          +
                        </button>
                      </div>
              ...
              {cart.length > 0 && (
                <div className="p-6 border-t border-slate-100 bg-white">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <span className="text-2xl font-mono font-black tracking-tighter text-slate-900">
