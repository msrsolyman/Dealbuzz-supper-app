      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {sellers.map(seller => (
          ...
          >
            ...
            <div className="h-28 bg-gradient-to-br from-indigo-600 via-fuchsia-500 to-rose-500 relative overflow-hidden">
               {/* Pattern overlay */}
               ...
               <div className="absolute -bottom-8 left-6 w-16 h-16 bg-white rounded-2xl shadow-xl border-4 border-white flex items-center justify-center text-indigo-600 font-bold group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-300 relative z-10">
                <Store className="w-7 h-7" />
              </div>
            </div>
            <div className="pt-12 px-6 pb-6 flex-1 flex flex-col relative z-10">
              <h3 className="text-xl font-display font-bold text-slate-900 mb-1 flex items-center gap-2 leading-tight">
                {seller.name} <ShieldCheck className="w-4.5 h-4.5 text-emerald-500" />
              </h3>
              ...
              <div className="text-sm text-slate-500 line-clamp-2 mb-6 leading-relaxed flex-1">
                Providing premium products and exceptional services. View profile for more details.
              </div>
