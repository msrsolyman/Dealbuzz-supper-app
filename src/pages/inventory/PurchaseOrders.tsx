              ...
              {loading ? (
                ...
                pos.map((po) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 rounded text-[10px] font-bold uppercase tracking-widest ${po.status === "RECEIVED" ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"}`}
                      >
                        {po.status}
                      </span>
                    </td>
                      ...
                      <div className="flex items-center justify-end gap-2">
                        {po.status !== "RECEIVED" && (
                          <button
                            ...
                            className="bg-indigo-50 text-indigo-600 hover:bg-indigo-100 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest"
                          >
                            Receive
                          </button>
                        )}
          ...
          <div className="bg-white rounded-3xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl">
            <div className="p-6 border-b border-slate-100 flex justify-between items-center">
              ...
              >
                ...
                <span className="text-xl leading-none absolute top-6 right-6">
                  ×
                </span>
              </button>
            </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    onClick={addItem}
                    type="button"
                    className="text-indigo-600 bg-indigo-50 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest flex items-center gap-1 hover:bg-indigo-100"
                  >
            ...
            <div className="p-6 border-t border-slate-100 flex justify-end gap-3 bg-slate-50 rounded-b-3xl">
              <div className="flex-1 flex items-center text-sm font-black text-slate-900 uppercase tracking-widest gap-2">
                ...
                <span className="font-mono text-indigo-600 text-lg">
                  {formatAmount(
                    formData.items.reduce((s, i) => s + i.total, 0),
                  )}
                </span>
              </div>
              <button
