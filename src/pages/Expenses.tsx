  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await fetchWithAuth("/expenses", {
        ...
        }), // temporary fallback, backend should use req.user.id
      });
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:border-indigo-500 transition-all text-slate-900"
                  />
                </div>
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">
