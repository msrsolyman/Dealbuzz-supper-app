...
export default function Manufacturing() {
  ...
  useEffect(() => {
    loadOrders();
    toast.info(
      "This is a structural module for Manufacturing. UI logic inside modal needs complex BOM (Bill of Materials) setup.",
    );
  }, []);
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-white border border-slate-200/60 shadow-sm rounded-3xl p-12 text-center">
        ...
        <p className="text-sm font-medium text-slate-500 max-w-sm mx-auto">
          Create complex Bill of Materials (BOM) to track raw materials
          converted into finished goods. Automated deduction of components on
          production complete.
        </p>
      </div>
    </div>
