      ...
      {widgets.financialMetrics && (
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          <div className="bg-white p-5 md:p-6 border border-slate-200/60 rounded-[1.5rem] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
            ...
            <div className="text-[9px] text-slate-400 uppercase font-bold tracking-[0.2em] mb-4 relative z-10">
              {t("total_products")}
            </div>
            <div className="text-3xl font-display font-black text-slate-900 mb-2 relative z-10 tracking-tighter">
              {stats.products}
            </div>
            <div className="text-[9px] text-emerald-600 font-bold uppercase tracking-widest relative z-10 bg-emerald-50 inline-block px-1.5 py-0.5 rounded">
              +15 added
            </div>
          </div>
          ...
          <div className="bg-white p-5 md:p-6 border border-slate-200/60 rounded-[1.5rem] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
            ...
            <div className="text-[9px] text-fuchsia-600 font-bold uppercase tracking-widest relative z-10 bg-fuchsia-50 inline-block px-1.5 py-0.5 rounded">
              Processing
            </div>
          </div>

          <div className="bg-[#0f172a] p-5 md:p-6 border border-slate-800 rounded-[1.5rem] shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
            ...
            <div className="text-3xl font-display font-black text-white mb-2 relative z-10 tracking-tighter">
              {stats.lowStockCount}
            </div>
            <div className="text-[9px] text-amber-400 font-bold uppercase tracking-widest relative z-10 bg-amber-500/10 border border-amber-500/20 inline-block px-1.5 py-0.5 rounded">
              Items low stock
            </div>
          </div>
          ...
          <div className="bg-white p-5 md:p-6 border border-slate-200/60 rounded-[1.5rem] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
            ...
            <div className="absolute top-5 right-5 opacity-20 group-hover:opacity-40 group-hover:scale-110 transition-all">
              <Users className="w-10 h-10 text-sky-500" strokeWidth={1.5} />
            </div>
            <div className="text-[9px] text-slate-400 uppercase font-bold tracking-[0.2em] mb-4 relative z-10">
              {t("active_users")}
            </div>
            ...
            <div className="text-[9px] text-sky-600 font-bold uppercase tracking-widest relative z-10 bg-sky-50 inline-block px-1.5 py-0.5 rounded">
              System Online
            </div>
          </div>
        </div>
