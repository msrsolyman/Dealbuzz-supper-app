  ...
  return (
    <div className="max-w-6xl mx-auto h-full flex flex-col pt-4 font-sans">
      <div className="mb-10 text-center relative">
        ...
        <h1 className="text-4xl md:text-5xl font-display font-black text-slate-900 tracking-tight mb-4 leading-tight relative z-10">
          Sellers Directory
        </h1>
        <p className="text-slate-500 max-w-2xl mx-auto leading-relaxed text-base md:text-lg relative z-10">
          Explore top-rated sellers and exceptional businesses across our
        ...
        {sellers.map((seller) => (
          ...
          >
            ...
            <div className="pt-12 px-6 pb-6 flex-1 flex flex-col relative z-10">
              ...
              <p className="text-[10px] uppercase font-bold text-indigo-600 tracking-widest mb-4 bg-indigo-50/50 inline-block w-fit px-2 py-0.5 rounded-md border border-indigo-100 mt-1">
        ...
        {sellers.length === 0 && (
          <div className="col-span-full py-12 text-center border-2 border-dashed border-slate-200 rounded-2xl">
            ...
            <p className="text-slate-500 font-medium">
              No sellers found in the directory.
            </p>
          </div>
        )}
      </div>
