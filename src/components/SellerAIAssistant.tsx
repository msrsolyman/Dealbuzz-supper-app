...
export default function SellerAIAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome',
      role: 'model',
      content: 'Hello! I am your AI Business Advisor. How can I help you grow your business, optimize your products, or increase your sales today?'
    }
  ]);
  ...
  if (!['product_seller', 'service_seller', 'reseller'].includes(user?.role || '')) {
    return null;
  }
            ...
            >
              ...
              <div className="bg-gradient-to-r from-indigo-600 to-fuchsia-600 p-5 flex justify-between items-center text-white shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-black tracking-tight leading-tight">AI Advisor</h3>
                    <p className="text-[10px] font-medium text-indigo-100 uppercase tracking-widest">Business Guide</p>
                  </div>
                </div>
                <button 
                  onClick={() => setIsOpen(false)}
